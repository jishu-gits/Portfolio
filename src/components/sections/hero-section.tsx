...
export function HeroSection({ profile }: { profile: Profile }) {
  ...
  return (
    ...
    >
      ...
      <ParticleField />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(5,5,5,0.2),rgba(5,5,5,0.92))]" />

      <div className="container relative z-10 grid gap-12 pb-16 pt-12 lg:grid-cols-[minmax(0,1fr)_420px] lg:items-center">
        <div className="max-w-4xl" data-gsap-reveal>
          <Badge className="mb-6" variant="accent">
            {profile.availability}
          </Badge>
          <h1 className="max-w-5xl text-5xl font-semibold leading-[1.02] text-foreground sm:text-6xl lg:text-7xl">
            {profile.headline}
          </h1>
